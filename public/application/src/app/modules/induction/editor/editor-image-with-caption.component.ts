...
@Component({
	selector: 'editor-image-with-caption',
	template: `
		<form 
			...
			<div class="editor-image-with-caption">
				<div class="control-wrapper">
					...
					<ul class="err-list" *ngIf="imageWithCaptionForm.get('caption').touched">
						<li 
							class="err-item"
							*ngIf="imageWithCaptionForm.get('caption').errors?.required">
...
export class EditorImageWithCaption implements OnInit, OnDestroy, OnChanges {
	...
	public ngOnInit(): void {
		...
		if( this.slide ) {
			if( 'name' in this.slide ) 
				...
				this.previousValueSet['caption'] = this.slide.resource[0].caption;
		...
		this.formValueChanges = this.imageWithCaptionForm.valueChanges
			.subscribe(
				(res: ICompareValuesImageCaption) => {
					this.currentValueSet['caption'] = res.caption;
